    ...
    fetch('./get_properties.php')
        ...
        .then(data => {
            ...
            data.forEach(property => {
                const propertyCard = `
                    <div class="col">
                        <div class="card custom-card">
                            <img src="data:image/jpeg;base64,${property.image}" class="card-img-top" alt="${property.name}">
                            <div class="card-body">
                ...
                allPropertiesList.insertAdjacentHTML('beforeend', propertyCard);
            });
        })
    ...
    fetch('../get_properties.php')
        ...
        .then(data => {
            ...
            data.forEach(property => {
                ...
                // Inserta la tarjeta de propiedad en ambos contenedores
                propertyList.insertAdjacentHTML('beforeend', propertyCard);
                allPropertiesList.insertAdjacentHTML('beforeend', propertyCard);
            });
        })
